...
project = 'Minimum Viable Blog'

# Change this to the tagline of your blog
tagline = 'No more blog than necessary.'

# Change this to the description of your blog
description = 'Somewhere to write my random thoughts, with as little verbosity as I can manage.'
...
website = 'http://minimumviablesite.com/blog/'
